  ...
  return (
    <div className="fixed bottom-6 right-6" style={{ zIndex: 9999 }}>
      <div className="relative">
        ...
        {/* Hover Tooltip */}
        <div className={`
          absolute right-20 top-1/2 transform -translate-y-1/2 bg-gray-900 text-white px-3 py-2 rounded-lg
          whitespace-nowrap text-sm font-medium shadow-lg pointer-events-none
